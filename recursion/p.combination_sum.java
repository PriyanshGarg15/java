...
public class combination_sum {
    ...
    public static void findCombinations(int[] candidates, int target, int startIndex, List<Integer> currentCombination, List<List<Integer>> result) {
        ...
        // Explore the "take" option
        currentCombination.add(candidates[startIndex]);
        findCombinations(candidates, target - candidates[startIndex], startIndex, currentCombination, result);
        currentCombination.remove(currentCombination.size() - 1);
        // Explore the "not take" option
        findCombinations(candidates, target, startIndex + 1, currentCombination, result);
    }
